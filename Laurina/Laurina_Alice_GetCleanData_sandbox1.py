...
# get_latt_long gets(country_input, query_input) latitude and longitude 
...
def get_latt_long(country_input, query_input):
    try:
        ...
        return(f"Oops! Not a valid location name. Please enter another location.")
...
# where the pure_date falls within one of the intervals.
